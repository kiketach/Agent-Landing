  export default defineNuxtConfig({
    ...
    app: {
      head: {
        ...
        script: [
          // Considerar cargar FontAwesome de forma más moderna si es posible (ej. con un módulo Nuxt o importación directa)
  ...
  nitro: {
    preset: 'static',
    externals: {
      external: ['protobufjs'] // Tratar protobufjs como externo
    }
  }
  })
